...
case "$1" in
        galaxys)
            VARIANT="galaxys"
            VER=""
	    BASE_SEMA_VER="GearKernel_JBPlus_GalaxyS_1.0.3"
            ;;

        galaxysb)
            VARIANT="galaxysb"
            VER="b"
	    BASE_SEMA_VER="GearKernel_JBPlus_GalaxySB_1.0.3"
            ;;

        captivate)
            VARIANT="captivate"
            VER="c"
	    BASE_SEMA_VER="GearKernel_JBPlus_Captivate_1.0.3"
            ;;

        vibrant)
            VARIANT="vibrant"
            VER="v"
	    BASE_SEMA_VER="GearKernel_JBPlus_Vibrant_1.0.3"
            ;;
