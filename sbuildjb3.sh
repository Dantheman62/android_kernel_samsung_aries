...
case "$1" in
        galaxys)
            VARIANT="galaxys"
            VER=""
	    BASE_SEMA_VER="GearKernel_JB3_GalaxyS_1.0.6"
            ;;

        galaxysb)
            VARIANT="galaxysb"
            VER="b"
	    BASE_SEMA_VER="GearKernel_JB3_GalaxySB_1.0.6"
            ;;

        captivate)
            VARIANT="captivate"
            VER="c"
	    BASE_SEMA_VER="GearKernel_JB3_Captivate_1.0.6"
            ;;

        vibrant)
            VARIANT="vibrant"
            VER="v"
	    BASE_SEMA_VER="GearKernel_JB3_Vibrant_1.0.6"
            ;;
