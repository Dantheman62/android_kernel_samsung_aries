...
case "$1" in
        galaxys)
            VARIANT="galaxys"
            VER=""
	    BASE_SEMA_VER="GearKernel_Universal_GalaxyS_1.1.0"
        ...
        galaxysb)
            VARIANT="galaxysb"
            VER="b"
	    BASE_SEMA_VER="GearKernel_Universal_GalaxySB_1.1.0"
        ...
        captivate)
            VARIANT="captivate"
            VER="c"
	    BASE_SEMA_VER="GearKernel_Universal_Captivate_1.1.0"
        ...
        vibrant)
            VARIANT="vibrant"
            VER="v"
	    BASE_SEMA_VER="GearKernel_Universal_Vibrant_1.1.0"
