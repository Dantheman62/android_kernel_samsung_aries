...
OPTIMIZATION_FLAGS = -Ofast -march=armv7-a -mtune=cortex-a8 -mfpu=neon -fpredictive-commoning -ffast-math -funswitch-loops -fpredictive-commoning -fgcse-after-reload -ftree-vectorize -fipa-cp-clone -fsingle-precision-constant -fgcse-lm -fgcse-sm -fsched-spec-load -fforce-addr -pipe
